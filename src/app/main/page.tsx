  ...
  return (
    <div>
      ...
      <div className='bg-[#191f23] text-[#c6d2d5] font-custom text-center text-xl'>
        ...
        빛과 소리, 공감각적인 경험을 통해 저희의 이야기를 풀어나갑니다.  <br/>

        2011년 3월 11일에 발생한 일본의 대지진과 쓰나미로 인해 후쿠시마 제1원전에서 원자로 냉각장치가 작동 중지되어 원전으로부터 방출된 방사능이 지역에 큰 피해를 끼쳤습니다. <br/>

        후쿠시마 원전사고는 역사상 가장 심각한 사고레벨인 7단계를 기록하고 있으며, 이는 체르노빌 원전사고와 동일한 사고레벨이자 가장 심각한 사고임을 나타내는 수치입니다. <br/>

        방사능 유출과 쓰나미로 인해 삶의 터전을 잃은 수많은 주민들은 사고의 기억에서 벗어나지 못한 채 여전히 고통받고 있습니다. <br/>

        저희는 이러한 전시를 통해 ‘인류애’를 전시라는 폼을 통해 여러분께 경험으로 전달해드리고자 합니다. <br/>
